...
#define EXAMPLE_DEVICE_NAME "liuyue's bluetooth"
...
void Dri_BLE_Init(void)
{
    ...
    // esp_bluedroid_init() 负责为蓝牙协议栈（Bluedroid）的“主机 (Host)”部分分配和初始化资源
